...
class TestCaseGradeMemoryService(TestCase):
    def setUp(self):
...
class TestCaseGradeFileService(TestCase):
    def setUp(self):
        self.__s_repo = InFileStudentRepository('tests/data/test_student_service.txt')
        self.__t_repo = InFileTaskRepository('tests/data/test_task_service.txt')
        self.__repo = InFileGradeRepository('tests/data/test_grade_service.txt')
        self.__validator = GradeValidator()
        self.__service = GradeService(self.__repo, self.__validator, self.__s_repo, self.__t_repo)
        self.tearDown()
    ...
    def tearDown(self):
        self.__s_repo.remove_all()
        self.__t_repo.remove_all()
