class FiniteAutomaton:
    ...
    def longest_accepted_prefix(self, sequence: str) -> str:
        ...
        if last_accepted_pos != -1:
            return sequence[:last_accepted_pos+1], last_accepted_pos
        elif self.__initial_state in self.__final_states:
            return 'epsilon'

        return '', last_accepted_pos
    ...
    def __is_deterministic(self) -> bool:
        ...
        for state in self.__states:
            for symbol in self.__alphabet:
                ...
                if symbol in self.__transitions[state] and type(self.__transitions[state][symbol]) == list:
                    return False
